MCZ2_Header:
	...
	smpsHeaderVoice     MCZ2_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $A7

	smpsHeaderDAC       MCZ2_DAC
	smpsHeaderFM        MCZ2_FM1,	$00, $0C
	smpsHeaderFM        MCZ2_FM2,	$00, $0A
	smpsHeaderFM        MCZ2_FM3,	$00, $0C
	smpsHeaderFM        MCZ2_FM4,	$00, $10
	smpsHeaderFM        MCZ2_FM5,	$00, $10
	smpsHeaderPSG       MCZ2_PSG1,	$DC, $04, $00, fTone_0B
	smpsHeaderPSG       MCZ2_PSG2,	$DC, $02, $00, fTone_01
	smpsHeaderPSG       MCZ2_PSG3,	$00, $03, $00, fTone_02
...
MCZ2_Loop04:
	dc.b	nRst, $30, nRst
	smpsLoop            $00, $09, MCZ2_Loop04
	smpsCall            MCZ2_Call03
	dc.b	nRst, $30, nRst
	smpsAlterPitch      $03
	smpsCall            MCZ2_Call04
	dc.b	nRst, $30, nRst
	smpsAlterPitch      $FD
	smpsCall            MCZ2_Call03
	dc.b	nRst, $30, nRst, nRst, nRst
	smpsJump            MCZ2_Jump02
...
MCZ2_Loop07:
	...
	smpsLoop            $00, $07, MCZ2_Loop07
	dc.b	nA5, $0C, nE6, $08, nA5, $0C, nC6, nA5, $06, nRst, $2E
	smpsJump            MCZ2_Loop06
...
MCZ2_Loop03:
	...
	smpsLoop            $00, $07, MCZ2_Loop03
	smpsAlterVol        $FA
	dc.b	nA5, $0C, nE6, $08, nA5, $0C, nC6, nA5, $06, nRst, $2E
	smpsPan             panRight, $00
	smpsJump            MCZ2_Loop02
