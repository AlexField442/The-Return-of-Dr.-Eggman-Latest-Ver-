MTZ3_Header:
	...
	smpsHeaderVoice     MTZ3_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $E0

	smpsHeaderDAC       MTZ3_DAC
	smpsHeaderFM        MTZ3_FM1,	$F3, $10
	smpsHeaderFM        MTZ3_FM2,	$17, $0C
	smpsHeaderFM        MTZ3_FM3,	$0B, $14
	smpsHeaderFM        MTZ3_FM4,	$0B, $18
	smpsHeaderFM        MTZ3_FM5,	$0B, $18
	smpsHeaderPSG       MTZ3_PSG1,	$E7, $06, $00, $00
	smpsHeaderPSG       MTZ3_PSG2,	$DB, $08, $00, $00
	smpsHeaderPSG       MTZ3_PSG3,	$FF, $02, $00, fTone_03

; PSG1 Data
MTZ3_PSG1:
	smpsJump            MTZ3_Jump02
...
MTZ3_FM1:
	dc.b	nRst, $30, nRst
	smpsLoop            $00, $04, MTZ3_FM1

MTZ3_Loop09:
	dc.b	nRst, $30, nRst
	smpsLoop            $00, $04, MTZ3_Loop09
	smpsAlterPitch      $0C
	smpsSetvoice        $03
...
MTZ3_Loop0B:
	dc.b	nRst, $30, nRst
	smpsLoop            $00, $04, MTZ3_Loop0B

MTZ3_Loop0C:
	dc.b	nRst, $30, nRst
	smpsLoop            $00, $07, MTZ3_Loop0C
...
MTZ3_Loop0D:
	...
	smpsLoop            $00, $02, MTZ3_Loop0D

MTZ3_Loop0E:
	dc.b	nRst, $30, nRst
	smpsLoop            $00, $09, MTZ3_Loop0E
	smpsJump            MTZ3_Loop0C
...
; DAC Data
MTZ3_DAC:
	smpsCall            MTZ3_Call00
	smpsLoop            $00, $02, MTZ3_DAC

MTZ3_Loop00:
	smpsCall            MTZ3_Call00
	smpsLoop            $00, $0B, MTZ3_Loop00
	dc.b	dKick, $0C, dLowTom, dSnare, dKick, dKick, dFloorTom, dSnare, dScratch, $04, $06, $02
	dc.b	dKick, $0C, nRst, nRst, nRst, nRst, nRst, nRst, dClap
	smpsJump            MTZ3_Loop00
