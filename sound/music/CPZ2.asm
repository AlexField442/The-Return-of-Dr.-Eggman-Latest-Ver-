CPZ2_Header:
	...
	smpsHeaderVoice     CPZ2_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $CE

	smpsHeaderDAC       CPZ2_DAC
	smpsHeaderFM        CPZ2_FM1,	$00, $08
	smpsHeaderFM        CPZ2_FM2,	$00, $0C
	smpsHeaderFM        CPZ2_FM3,	$00, $10
	smpsHeaderFM        CPZ2_FM4,	$00, $10
	smpsHeaderFM        CPZ2_FM5,	$00, $10
	smpsHeaderPSG       CPZ2_PSG1,	$00, $07, $00, $00
	smpsHeaderPSG       CPZ2_PSG2,	$00, $07, $00, $00
	smpsHeaderPSG       CPZ2_PSG3,	$00, $00, $00, fTone_02
...
CPZ2_Call00:
	dc.b	dKick, $18, dLowSnareS3, $0C, dKick, $18, $0C, dLowSnareS3, dKick, dKick, $18, dLowSnareS3
	dc.b	$0C, dKick, $12, dKick, dLowSnareS3, $18, dKick, dLowSnareS3, $0C, dKick, $18, $0C
	dc.b	dLowSnareS3, dKick, dKick, $18, dLowSnareS3, $0C, dKick, $18, dLowSnareS3, $0C, dLowSnareS3, dLowSnareS3
	dc.b	$06, dLowSnareS3
	smpsReturn
...
CPZ2_Call01:
	dc.b	dKick, $18, dLowSnareS3, $0C, dKick, $18, $0C, dLowSnareS3, dKick, dKick, $18, dLowSnareS3
	dc.b	$0C, dKick, $12, dKick, dLowSnareS3, $18, dKick, dLowSnareS3, $0C, dKick, $18, $0C
	dc.b	dLowSnareS3, dKick, dKick, $18, dLowSnareS3, $0C, dKick, dLowSnareS3, $06, dLowSnareS3, dLowSnareS3, dLowSnareS3
	dc.b	dLowSnareS3, dLowSnareS3, dLowSnareS3, dLowSnareS3
	smpsReturn

; FM1 Data
CPZ2_FM1:
	smpsModSet          $06, $01, $FA, $04
	smpsCall            CPZ2_Call05
	dc.b	nRst, $30, nRst
	smpsCall            CPZ2_Call05
	dc.b	nRst, $30
	smpsCall            CPZ2_Call06
...
CPZ2_Loop10:
	...
	smpsAlterVol        $FF
	smpsLoop            $00, $02, CPZ2_Loop10
	smpsCall            CPZ2_Call08
	smpsCall            CPZ2_Call09
	smpsCall            CPZ2_Call08
	smpsSetvoice        $00
	dc.b	nCs4, $06, nE4, nFs4, nAb4, $02, smpsNoAttack, nA4, $0A, nFs4, $06, nCs4
...
CPZ2_Loop0C:
	smpsCall            CPZ2_Call02
	smpsLoop            $00, $02, CPZ2_Loop0C

CPZ2_Loop0D:
	smpsCall            CPZ2_Call02
	smpsLoop            $00, $04, CPZ2_Loop0D
	smpsModOff

CPZ2_Loop0E:
	dc.b	nAb5, $12, nRst, $06, nAb5, $12, nRst, $06, nA5, $0C, nRst, $24
	dc.b	nRst, $30, nRst
	smpsLoop            $00, $04, CPZ2_Loop0E
...
CPZ2_Loop08:
	smpsCall            CPZ2_Call04
	smpsLoop            $00, $02, CPZ2_Loop08

CPZ2_Loop09:
	smpsCall            CPZ2_Call04
	smpsLoop            $00, $04, CPZ2_Loop09
	smpsModOff

CPZ2_Loop0A:
	dc.b	nB5, $12, nRst, $06, nB5, $12, nRst, $06, nCs6, $0C, nRst, $24
	dc.b	nRst, $30, nRst
	smpsLoop            $00, $04, CPZ2_Loop0A
	smpsModSet          $0C, $01, $05, $04

CPZ2_Loop0B:
	dc.b	nRst, $30, nRst
	smpsLoop            $00, $02, CPZ2_Loop0B
	smpsSetvoice        $05
	smpsAlterVol        $F8
	dc.b	nFs5, $04, nRst, $08, nE5, $04, nRst, $08, nFs5, $0C, nE5, $06
	dc.b	nFs5, $04, nRst, $08, nFs5, $06, nE5, $04, nRst, $08, nFs5, $0C
...
CPZ2_Loop04:
	smpsCall            CPZ2_Call02
	smpsLoop            $00, $02, CPZ2_Loop04

CPZ2_Jump00:
	smpsSetvoice        $03

CPZ2_Loop05:
	smpsCall            CPZ2_Call03
	smpsLoop            $00, $03, CPZ2_Loop05
	dc.b	nE2, $0C, nE3, $06, nRst, nEb3, nRst, nE3, nEb2, nRst, nEb2, nEb3
	dc.b	nRst, nCs3, nRst, nEb3, $0C
	smpsLoop            $01, $04, CPZ2_Loop05
	dc.b	nRst, $30, nRst
...
CPZ2_Loop07:
	...
	smpsLoop            $00, $04, CPZ2_Loop07
	smpsAlterVol        $08
	smpsJump            CPZ2_Jump00
...
CPZ2_Loop03:
	...
	smpsJump            CPZ2_Loop03

; DAC Data
CPZ2_DAC:
	smpsCall            CPZ2_Call00
	smpsLoop            $00, $02, CPZ2_DAC

CPZ2_Loop00:
	smpsCall            CPZ2_Call00
	smpsLoop            $00, $03, CPZ2_Loop00
	smpsCall            CPZ2_Call01

CPZ2_Loop01:
	smpsCall            CPZ2_Call00
	smpsLoop            $00, $02, CPZ2_Loop01
	smpsCall            CPZ2_Call01
	smpsJump            CPZ2_Loop00
