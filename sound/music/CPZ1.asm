CPZ1_Header:
	...
	smpsHeaderVoice     CPZ1_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $EE

	smpsHeaderDAC       CPZ1_DAC
	smpsHeaderFM        CPZ1_FM1,	$00, $08
	smpsHeaderFM        CPZ1_FM2,	$00, $0C
	smpsHeaderFM        CPZ1_FM3,	$00, $10
	smpsHeaderFM        CPZ1_FM4,	$00, $10
	smpsHeaderFM        CPZ1_FM5,	$00, $10
	smpsHeaderPSG       CPZ1_PSG1,	$00, $07, $00, $00
	smpsHeaderPSG       CPZ1_PSG2,	$00, $07, $00, $00
	smpsHeaderPSG       CPZ1_PSG3,	$00, $00, $00, fTone_02
...
CPZ1_Loop10:
	...
	smpsAlterVol        $FF
	smpsLoop            $00, $02, CPZ1_Loop10
	smpsCall            CPZ1_Call08
	smpsCall            CPZ1_Call09
	smpsCall            CPZ1_Call08
	smpsSetvoice        $00
	dc.b	nCs4, $06, nE4, nFs4, nAb4, $02, smpsNoAttack, nA4, $0A, nFs4, $06, nCs4
...
CPZ1_Loop0C:
	smpsCall            CPZ1_Call02
	smpsLoop            $00, $02, CPZ1_Loop0C

CPZ1_Loop0D:
	smpsCall            CPZ1_Call02
	smpsLoop            $00, $04, CPZ1_Loop0D
	smpsModOff

CPZ1_Loop0E:
	dc.b	nAb5, $12, nRst, $06, nAb5, $12, nRst, $06, nA5, $0C, nRst, $24
	dc.b	nRst, $30, nRst
	smpsLoop            $00, $04, CPZ1_Loop0E
...
CPZ1_Loop08:
	smpsCall            CPZ1_Call04
	smpsLoop            $00, $02, CPZ1_Loop08

CPZ1_Loop09:
	smpsCall            CPZ1_Call04
	smpsLoop            $00, $04, CPZ1_Loop09
	smpsModOff

CPZ1_Loop0A:
	dc.b	nB5, $12, nRst, $06, nB5, $12, nRst, $06, nCs6, $0C, nRst, $24
	dc.b	nRst, $30, nRst
	smpsLoop            $00, $04, CPZ1_Loop0A
	smpsModSet          $0C, $01, $05, $04

CPZ1_Loop0B:
	dc.b	nRst, $30, nRst
	smpsLoop            $00, $02, CPZ1_Loop0B
	smpsSetvoice        $05
	smpsAlterVol        $F8
	dc.b	nFs5, $04, nRst, $08, nE5, $04, nRst, $08, nFs5, $0C, nE5, $06
	dc.b	nFs5, $04, nRst, $08, nFs5, $06, nE5, $04, nRst, $08, nFs5, $0C
...
CPZ1_Loop04:
	smpsCall            CPZ1_Call02
	smpsLoop            $00, $02, CPZ1_Loop04

CPZ1_Jump00:
	smpsSetvoice        $03

CPZ1_Loop05:
	smpsCall            CPZ1_Call03
	smpsLoop            $00, $03, CPZ1_Loop05
	dc.b	nE2, $0C, nE3, $06, nRst, nEb3, nRst, nE3, nEb2, nRst, nEb2, nEb3
	dc.b	nRst, nCs3, nRst, nEb3, $0C
	smpsLoop            $01, $04, CPZ1_Loop05
	dc.b	nRst, $30, nRst
...
CPZ1_Loop07:
	...
	smpsLoop            $00, $04, CPZ1_Loop07
	smpsAlterVol        $08
	smpsJump            CPZ1_Jump00
...
CPZ1_Loop03:
	...
	smpsJump            CPZ1_Loop03

; DAC Data
CPZ1_DAC:
	smpsCall            CPZ1_Call00
	smpsLoop            $00, $02, CPZ1_DAC

CPZ1_Loop00:
	smpsCall            CPZ1_Call00
	smpsLoop            $00, $03, CPZ1_Loop00
	smpsCall            CPZ1_Call01

CPZ1_Loop01:
	smpsCall            CPZ1_Call00
	smpsLoop            $00, $02, CPZ1_Loop01
	smpsCall            CPZ1_Call01
	smpsJump            CPZ1_Loop00
