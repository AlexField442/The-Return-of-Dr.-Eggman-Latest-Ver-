MTZ2_Header:
	...
	smpsHeaderVoice     MTZ2_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $F8

	smpsHeaderDAC       MTZ2_DAC
	smpsHeaderFM        MTZ2_FM1,	$F4, $0E
	smpsHeaderFM        MTZ2_FM2,	$18, $0A
	smpsHeaderFM        MTZ2_FM3,	$0C, $14
	smpsHeaderFM        MTZ2_FM4,	$0C, $16
	smpsHeaderFM        MTZ2_FM5,	$0C, $16
	smpsHeaderPSG       MTZ2_PSG1,	$E8, $06, $00, $00
	smpsHeaderPSG       MTZ2_PSG2,	$DC, $08, $00, $00
	smpsHeaderPSG       MTZ2_PSG3,	$00, $02, $00, fTone_03

; PSG1 Data
MTZ2_PSG1:
	smpsJump            MTZ2_Jump02
...
MTZ2_FM1:
	dc.b	nRst, $30, nRst
	smpsLoop            $00, $04, MTZ2_FM1

MTZ2_Loop09:
	dc.b	nRst, $30, nRst
	smpsLoop            $00, $04, MTZ2_Loop09
	smpsAlterPitch      $0C
	smpsSetvoice        $03
...
MTZ2_Loop0B:
	dc.b	nRst, $30, nRst
	smpsLoop            $00, $04, MTZ2_Loop0B

MTZ2_Loop0C:
	dc.b	nRst, $30, nRst
	smpsLoop            $00, $07, MTZ2_Loop0C
...
MTZ2_Loop0D:
	...
	smpsLoop            $00, $02, MTZ2_Loop0D

MTZ2_Loop0E:
	dc.b	nRst, $30, nRst
	smpsLoop            $00, $09, MTZ2_Loop0E
	smpsJump            MTZ2_Loop0C
...
MTZ2_Jump00:
	...
	smpsJump            MTZ2_Jump00


MTZ2_Call00:
	dc.b	dKick, $0C, dLowTomS3, dSnareS3, dKick, dKick, dFloorTomS3, dSnareS3, dScratch, $04, $06, $02
	dc.b	dKick, $0C, dLowTomS3, dSnareS3, dKick, dKick, dFloorTomS3, dSnareS3, dClap
	smpsReturn

; DAC Data
MTZ2_DAC:
	smpsCall            MTZ2_Call00
	smpsLoop            $00, $02, MTZ2_DAC

MTZ2_Loop00:
	smpsCall            MTZ2_Call00
	smpsLoop            $00, $0B, MTZ2_Loop00
	dc.b	dKick, $0C, dLowTomS3, dSnareS3, dKick, dKick, dFloorTomS3, dSnareS3, dScratch, $04, $06, $02
	dc.b	dKick, $0C, nRst, nRst, nRst, nRst, nRst, nRst, dClap
	smpsJump            MTZ2_Loop00
