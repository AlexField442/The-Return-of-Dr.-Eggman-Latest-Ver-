...
off_B2CA:
	...
	dc.l off_B4B0, off_B4C4, off_B4F0
	dc.l off_B51C, PlusThanks, InMemory, -1

; credits text pointers for each screen of credits
vram_pnt := VRAM_Plane_A_Name_Table
off_B322: creditsPtrs	byte_BC46,textLoc($02,$0B), byte_BC51,textLoc($24,$0B), byte_BC55,textLoc($0C,$0F)
...
off_B3F0: creditsPtrs	byte_B7F2,textLoc($09,$06), byte_B6BC,textLoc($04,$0A), byte_B80B,textLoc($0A,$0C), byte_B821,textLoc($09,$0E), byte_B839,textLoc($07,$10), byte_B855,textLoc($0B,$12), byte_B869,textLoc($09,$14)
off_B41C: creditsPtrs	byte_B7B5,textLoc($09,$09), byte_B87D,textLoc($0A,$0B), byte_B893,textLoc($0B,$0F), byte_B8A8,textLoc($07,$11)
off_B436: creditsPtrs	byte_B8C5,textLoc($05,$07), byte_B8E2,textLoc($05,$0B), byte_B902,textLoc($04,$0D), byte_B90F,textLoc($05,$0F), MorihikoCredit,textLoc($06,$11), SasakiCredit,textLoc($08,$13)
off_B450: creditsPtrs	byte_B932,textLoc($04,$0B), byte_B954,textLoc($05,$0F)
; Sound assistants
off_B45E: creditsPtrs	byte_B974,textLoc($04,$05), byte_B995,textLoc($08,$09), byte_B9A1,textLoc($08,$0B), byte_B9AD,textLoc($06,$0D), byte_B9B8,textLoc($08,$0F), byte_B9C1,textLoc($09,$11), byte_B9C8,textLoc($04,$13), byte_B9D0,textLoc($07,$15)
...
; Play testing, special thanks, Sonic 2 Plus
...
PlayTest: creditsPtrs	PlayTestText,textLoc($08,$08), JoeCain,textLoc($0C,$0C)
PlusThanks: creditsPtrs Sonic2PlusThanks2,textLoc($02,$07), StealthCredit,textLoc($09,$0A), AureumberCredit,textLoc($0B,$0C), E122PsiCredit,textLoc($0C,$0E), EsraelCredit,textLoc($09,$10), SonicRetroCredit,textLoc($0A,$12), AndYouCredit,textLoc($03,$15)
InMemory: creditsPtrs	LeahSteur,textLoc($08,$0A), LeahSteur2,textLoc($09,$0E)
...
LeahSteur:	creditText 1,"DEDICATED  TO"
LeahSteur2:	creditText 1,"LEAH   STEUR"

PlayTestText:	creditText 1,"PLAY  TESTING"
JoeCain:	creditText 0,"JOE  CAIN"



Sonic2PlusThanks2:	creditText 1,"TRODE SPECIAL THANKS"
E122PsiCredit:		creditText 0,"E 122 PSI"
StealthCredit:		creditText 0,"SIMON THOMLEY"
AureumberCredit:	creditText 0,"AUREUMBER"
EsraelCredit:		creditText 0,"ESRAEL  NETO"
...
byte_B869:	creditText 0,"RIEKO KODAMA"
byte_B87D:	creditText 1,"ART  AND  CG"
byte_B893:	creditText 0,"TIM  SKELLY"
byte_B8A8:	creditText 0,"PETER  MORAWIEC"
byte_B8C5:	creditText 1,"MUSIC  COMPOSERS"
byte_B8E2:	creditText 0,"MASATO  NAKAMURA"
byte_B902:	creditText 0,"(DREAMS COME TRUE)"
byte_B90F:	creditText 0,"HIKOSHI HASHIMOTO"
MorihikoCredit:	creditText 0,"MIROHIKO AKIYAMA"
SasakiCredit:	creditText 0,"TOMOKO SASAKI"
byte_B932:	creditText 1,"SOUND  PROGRAMMER"
byte_B954:	creditText 0,"TOMOYUKI  SHIMADA"
byte_B974:	creditText 1,"SOUND  ASSISTANTS"		; <--
byte_B995:	creditText 0,"YUKIFUMI MAKINO"
byte_B9A1:	creditText 0,"HIROSHI KUBOTA"
byte_B9AD:	creditText 0,"YOSHIAKI KASHIMA"
byte_B9B8:	creditText 0,"IZUHO TAKEUCHI"
byte_B9C1:	creditText 0,"SACHIO OGAWA"
byte_B9C8:	creditText 0,"MASARU SETSUMARU"
byte_B9D0:	creditText 0,"MASAYUKI NAGAO"
...
byte_BC46:	creditText 0,"SONIC THE HEDGEHOG"
byte_BC51:	creditText 1,"2"
byte_BC55:	creditText 0,"BY SEGA"
...
byte_BCD9:	creditText 0,"AKINORI NISHIYAMA"
