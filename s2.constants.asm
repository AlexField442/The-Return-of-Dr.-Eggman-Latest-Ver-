...
double_jump_flag =	$1F
double_jump_property =	$20
invulnerable_time =	$21 ; time remaining until you stop blinking
...
PalID_SonicMenu =	id(PalPtr_SonicMenu)
PalID_TailsMenu =	id(PalPtr_TailsMenu)
PalID_KnuxMenu =	id(PalPtr_KnuxMenu)
PalID_AmyMenu =		id(PalPtr_AmyMenu)
PalID_EggmanMenu =	id(PalPtr_EggmanMenu)
PalID_RetroMenu =	id(PalPtr_RetroMenu)
PalID_Ending =		id(PalPtr_Ending)
...
PLCID_OwzBoss =		id(PLCptr_OwzBoss)
...
SndID_WFZLaserChrg =	id(SndPtr_WFZLaserChrg)
SndID_WFZLaserFire =	id(SndPtr_WFZLaserFire)
...
Camera_BG_Y_pos_copy:		ds.w	1	; $FFFFEE3A-$FFFFEE3B ; seems unused
...
Game_paused:			ds.w	1
Last_jump_press:		dc.b	1	
				ds.b	3	; $FFFFF63D-$FFFFF63F ; seems unused
...
Obj_respawn_data:		ds.b	$80	; Maximum possible number of respawn entries that S2 can handle; for stock S2, $80 is enough
...
Reset_LevelMusic_flag:		ds.b	1	; $FFFFFFCB

	;tst.b	(Reset_LevelMusic_flag).w	; is flag set?
	;bne.s	+				; if yes, branch
...
Menu_Theme:			ds.b	1
CurrentLanguage:		ds.b	1	; $FFFFFFE1
				ds.b	$E	; $FFFFFFE2-$FFFFFFEF ; seems unused
...
ArtTile_ArtNem_SpecialFlatShadow      = $023C-4
ArtTile_ArtNem_SpecialDiagShadow      = $0262-4
ArtTile_ArtNem_SpecialSideShadow      = $029C-4
